...
export const BurgerMenu = ({ onClose }: BurgerMenuProps) => {
    return (
        <div className="w-full space-y-25 bg-white p-4">
            <Link
                href="/"
                onClick={onClose}
                className="text-h3 absolute-x-center font-bold"
            >
                <LogoIcon alt="" />
            </Link>
            ...
            >
                <CloseIcon className="w-full" alt="Закрыть меню" />
            </button>
            ...
            <div className="flex-center flex-col gap-4">
                <p className="text-bold text-2xl">Наши темы</p>
                <TagMap />
            </div>
